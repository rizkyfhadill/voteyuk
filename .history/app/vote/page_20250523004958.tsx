      ...
      <div className="container">
        ...
        {!electionFound ? (
          ...
          >
            ...
            // Perubahan pada bagian TabsContent values "overview" dan "results"
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-900 dark:text-gray-100 font-medium">
                {new Date(election.start_time).toLocaleString('id-ID', {
                  day: 'numeric', 
                  month: 'long', 
                  year: 'numeric',
                  hour: '2-digit',
            ...
            <div>
              ...
              <p className="text-gray-900 dark:text-gray-100 font-medium">
                {new Date(election.end_time).toLocaleString('id-ID', {
                  day: 'numeric', 
                  month: 'long', 
                  year: 'numeric',
                  hour: '2-digit',
...
<TabsContent value="results">
  <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
    <CardHeader className="pb-3 border-b border-gray-100 dark:border-gray-800">
      ...
      <CardDescription className="dark:text-gray-400">
        {new Date() <= new Date(election?.end_time || "") && election?.showRealTimeResults === false
    ...
    <CardContent className="pt-6">
      {election && (
        <>
          {election.showRealTimeResults !== false || new Date() > new Date(election.end_time) ? (
            <div className="space-y-6">
              <div className="space-y-4">
                {election.candidates.map((candidate, index) => {
                  const votes = blockchainResults[candidate.id] || 0;
                  const totalVotes = Object.values(blockchainResults).reduce((sum, count) => sum + count, 0);
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">
                            {candidate.description ? candidate.description.substring(0, 60) + "..." : ""}
                          </p>
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                        ...
                        <div className="flex items-center mt-1">
                          <div className="w-24 md:w-48 h-3 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden mr-2">
                            <div
                          ...
                          <span className="text-xs font-medium text-gray-700 dark:text-gray-300 min-w-[42px]">
                            {percentage}%
                          </span>
                        </div>
                      </div>
              ...
              <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mt-4 border border-gray-200 dark:border-gray-700">
                <div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">Total Suara Masuk</p>
                  <p className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                    {Object.values(blockchainResults).reduce((sum, count) => sum + count, 0)}
                  </p>
                </div>
                
                <div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">Partisipasi</p>
                  <p className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                    {election.voters_count ? 
                      `${((Object.values(blockchainResults).reduce((sum, count) => sum + count, 0) / election.voters_count) * 100).toFixed(1)}%` : 
                      "0.0%"}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                <Button
                  ...
                  className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white border-0 w-full"
                >
            ...
            <div className="text-center py-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
                Hasil pemilihan akan ditampilkan setelah periode pemilihan berakhir
                pada {new Date(election.end_time).toLocaleString('id-ID', {
