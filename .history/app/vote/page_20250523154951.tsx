...
// If the correct file is 'VotingResults.tsx' or 'VotingResults/index.tsx', use:
import VotingResults from '@/components/VotingResults';
// Or, if the file is named differently, update the path to match the actual file name and casing.
                          ...
                          <div className="flex items-center">
                            <div className="w-48 h-4 bg-gray-100 rounded-full overflow-hidden mr-3">
                              <div
                                ...
                                style={{
                                  width: `${
                                    blockchainResults[candidate.id]
                                      ? Math.min(
                                          blockchainResults[candidate.id] * 10,
                                          100
                                        )
                                      : 0
                                  }%`,
