        ...
        <div className="container py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-white text-center md:text-left">
              <h3 className="text-lg font-semibold">Siap untuk pemilihan yang lebih transparan?</h3>
              <p className="text-teal-100 mt-1">Buat pemilihan pertama Anda sekarang, gratis!</p>
            </div>
