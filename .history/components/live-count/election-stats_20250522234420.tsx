    ...
    <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
      ...
      <CardContent className="space-y-4">
        ...
        >
          <div className="flex items-center">
            <div className="p-2 rounded-full bg-gradient-to-r from-teal-100 to-emerald-100 dark:from-teal-900/30 dark:to-emerald-900/30 mr-3">
              <Map className="h-5 w-5 text-teal-600 dark:text-teal-500" />
            </div>
            <span className="text-gray-600 dark:text-gray-300">
              TPS Melaporkan
            </span>
          ...
          <div className="flex items-center">
            ...
            <Badge
              variant="outline"
              className="ml-2 text-xs bg-emerald-50 border-emerald-100 text-emerald-700 dark:bg-emerald-900/20 dark:border-emerald-800/30 dark:text-emerald-400"
            >
              {Math.round(
                (stats.precincts.reporting / stats.precincts.total) * 100
              )}
              %
            </Badge>
          </div>
