        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Secure, transparent, and verifiable electronic voting platform
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  href="/"
                  className="text-gray-600 dark:text-gray-400 hover:text-teal-700 dark:hover:text-teal-500 transition"
                >
