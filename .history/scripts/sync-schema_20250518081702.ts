 ...
 * Type guard to check if an object is a Drizzle table
 */
PS C:\Users\faridfred\Documents\Development\VoteYuk> npm run migrate    

> my-v0-project@0.1.0 migrate
> tsx drizzle/migrate.ts

Running migrations...
Some migration errors occurred, falling back to schema sync
NeonDbError: relation "audit_logs" already exists
    at dr.execute (C:\Users\faridfred\Documents\Development\VoteYuk\node_modules\@neondatabase\serverless\index.js:1276:30) 
    at process.processTicksAndRejections (node:internal/process/task_queues:105:5)
    at async migrate (C:\Users\faridfred\Documents\Development\VoteYuk\node_modules\src\neon-http\migrator.ts:45:5)
    at async main (C:\Users\faridfred\Documents\Development\VoteYuk\drizzle\migrate.ts:24:7) {
  severity: 'ERROR',
  code: '42P07',
  detail: undefined,
  hint: undefined,
...
Running dynamic schema synchronization...
🔄 Starting dynamic schema synchronization...
Found 0 tables in schema definition

✅ Schema synchronization completed!
PS C:\Users\faridfred\Documents\Development\VoteYuk> 
